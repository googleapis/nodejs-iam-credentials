...
describe('v1.IAMCredentialsClient', () => {
    ...
    describe('generateAccessToken', () => {
        it('invokes generateAccessToken without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.iam.credentials.v1.GenerateAccessTokenResponse());
            ...
            assert((client.innerApiCalls.generateAccessToken as SinonStub)
    ...
    describe('generateIdToken', () => {
        it('invokes generateIdToken without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.iam.credentials.v1.GenerateIdTokenResponse());
            client.innerApiCalls.generateIdToken = stubSimpleCall(expectedResponse);
            const [response] = await client.generateIdToken(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.generateIdToken as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('signBlob', () => {
        it('invokes signBlob without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.iam.credentials.v1.SignBlobResponse());
    ...
    describe('signJwt', () => {
        it('invokes signJwt without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.iam.credentials.v1.SignJwtResponse());
