...
describe('v1.IAMCredentialsClient', () => {
    ...
    describe('generateAccessToken', () => {
        it('invokes generateAccessToken without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GenerateAccessTokenRequest', ['name']);
    ...
    describe('generateIdToken', () => {
        it('invokes generateIdToken without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GenerateIdTokenRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('signBlob', () => {
        it('invokes signBlob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SignBlobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('signJwt', () => {
        it('invokes signJwt without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SignJwtRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
